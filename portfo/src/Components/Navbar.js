    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <NavLink
            to="/"
            className="text-white text-lg sm:text-xl font-bold tracking-wide transition hover:text-cyan-400"
          >
            Rayan Ahmad
          </NavLink>
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <a
              href="/resume.pdf"
              download
              className="bg-cyan-500 hover:bg-cyan-400 hover:scale-105 active:scale-95 text-white px-4 py-2 rounded-lg transition-all duration-300"
            >
              Resume
            </a>
          </nav>
          ...
          <motion.button
            ...
            className="md:hidden text-white p-2 rounded-xl border border-white/10 hover:bg-white/10 hover:border-cyan-400/40 transition-all duration-300"
          >
